...
1	admin	admin@gmail.com	8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918	\N	\N	\N	\N	\N	t	t	t	f	\N	2025-05-31 04:23:54.859051+00	2025-05-31 04:25:45.502856+00
\.
...
friendly_store	{#F65658,#F49F36,#F5C860,#9AC17C,#4CB495,#569C9A,#60819C,#2F8AB1}	{PolarAreaChart,HeatmapChart}	間
\.
...
1	business_district	熱點商圈	circle	geojson	big	\N	{"circle-color":"#007BFF"}	[\n  {\n    "key": "district",\n    "name": "行政區"\n  },\n  {\n    "key": "business_district",\n    "name": "商圈名稱"\n  },\n  {\n    "key": "chairman_of_the_board",\n    "name": "理事長"\n  },\n  {\n    "key": "tel",\n    "name": "聯絡電話"\n  },\n  {\n    "key": "addr",\n    "name": "地址"\n  },\n  {\n    "key": "area",\n    "name": "市別"\n  }\n]
2	business_district_ntp	熱點商圈	circle	geojson	big	\N	{"circle-color":"#007BFF"}	[\n  {\n    "key": "district",\n    "name": "行政區"\n  },\n  {\n    "key": "business_district",\n    "name": "商圈名稱"\n  },\n  {\n    "key": "chairman_of_the_board",\n    "name": "理事長"\n  },\n  {\n    "key": "tel",\n    "name": "聯絡電話"\n  },\n  {\n    "key": "addr",\n    "name": "地址"\n  },\n  {\n    "key": "area",\n    "name": "市別"\n  }\n]
\.
...
362	rich	商圈共榮	{2,3,4}	3d_rotation	2025-05-31 10:03:18.559113+00	2025-05-31 00:00:00.247753+00
\.
...
friendly_store	\N	\N	\N	static	\N	\N	\N	產業局商業處	顯示雙北友善店家統計數量	顯示雙北友善店家統計數量	顯示雙北友善店家統計數量	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{team}	2025-05-31 00:00:00+00	2025-05-31 00:00:00+00	three_d	select x, y, data\nfrom friendly_store_tp	\N	taipei
store_rent	\N	\N	\N	static	\N	\N	\N	開放台灣民間租屋資料、591租屋網	以歷年租金資料為基礎，呈現指定區域（縣市、鄉鎮市區）的月租金變化趨勢，並以地理座標（經度、緯度）定位熱門商圈街區，透過圖表與地圖視覺化顯示租金波動與區段分布，讓使用者能直觀掌握租金走勢。	透過系統化且長期的租金資料分析，揭示各商圈的市場熱度及租金價格結構，協助評估商圈價值與投資風險，為不同角色提供決策依據。\n• 民眾可了解熱門商圈的租金概況，掌握消費與生活環境變化。\n• 業者能評估開店成本，選擇合適的商圈與租金區段。\n• 管委會則能監控租金走勢，做為規劃商圈發展與政策參考。	• 民眾可了解熱門商圈的租金概況，掌握消費與生活環境變化。\n• 業者能評估開店成本，選擇合適的商圈與租金區段。\n• 管委會則能監控租金走勢，做為規劃商圈發展與政策參考。	{https://rentalhouse.g0v.ddio.io/download,https://rent.591.com.tw/list}	{team}	2025-05-31 00:00:00+00	2025-05-31 00:00:00+00	three_d	select x_axis, y_axis, data\nfrom store_rent_tp\n	\N	taipei
